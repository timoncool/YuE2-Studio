export const en = {
    ...
    videoFailed: 'The video did not load. Check the link or pick another file.',
    setApiKey: 'Set API key',
    pexelsPhotos: 'Photos',
    pexelsVideos: 'Videos',
    videoBadge: 'VIDEO',
    fx_shake: 'Bass shake',
    fxDesc_shake: 'The camera shakes on low frequencies',
    fx_glitch: 'Digital glitch',
    fxDesc_glitch: 'Random artefacts',
    fx_vhs: 'VHS tape',
    fxDesc_vhs: 'Colour bleeding and noise',
    fx_cctv: 'CCTV',
    fxDesc_cctv: 'Night-vision look',
    fx_scanlines: 'Scanlines',
    fxDesc_scanlines: 'Old monitor effect',
    fx_chromatic: 'Aberration',
    fxDesc_chromatic: 'RGB split',
    fx_bloom: 'Bloom',
    fxDesc_bloom: 'Glow on bright areas',
    fx_filmGrain: 'Film grain',
    fxDesc_filmGrain: 'Cinematic noise',
    fx_pixelate: 'Pixelate',
    fxDesc_pixelate: 'Retro pixel look',
    fx_strobe: 'Strobe',
    fxDesc_strobe: 'Flashes on bass hits',
    fx_vignette: 'Vignette',
    fxDesc_vignette: 'Dark edges',
    fx_hueShift: 'Hue shift',
    fxDesc_hueShift: 'Colour rotation',
    fx_letterbox: 'Letterbox',
    fxDesc_letterbox: 'Cinematic bars',
